...
def test_su2_tensor():
    ...
    stp2 = SU2SymmetricTensor.from_array(
        sds_22t, (r, r, r), (r,), signature=[0, 0, 1, 1]
    )
    ...
    stbp2 = SU2SymmetricTensor.from_array(
        arrbp, (r, r, r), (r,), signature=[0, 0, 1, 1]
    )
    assert (stbp - stbp2).norm() < 1e-14
    ...
    st3 = SU2SymmetricTensor.from_array(
        arr, (r1,), (r12, r12, r1), signature=[0, 0, 1, 1]
    )
    assert lg.norm(st3.toarray() - arr) < 1e-14
    st3perm = st3.permute((0, 1), (2, 3))
    assert lg.norm(st3perm.toarray() - arr) < 1e-14
