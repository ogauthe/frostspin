...
def test_RVB():
    ...
    tA_U1 = U1SymmetricTensor.from_array(
        tRVB, rr_U1, rc_U1, signature=[0, 0, 1, 1, 1, 1]
    )
    tB_U1 = U1SymmetricTensor.from_array(
        tRVB, rr_U1, rc_U1, signature=[1, 1, 0, 0, 0, 0]
    )
    tA_O2 = O2SymmetricTensor.from_array(
        tRVB, rr_O2, rc_O2, signature=[0, 0, 1, 1, 1, 1]
    )
    tB_O2 = O2SymmetricTensor.from_array(
        tRVB, rr_O2, rc_O2, signature=[1, 1, 0, 0, 0, 0]
    )
    ...
    ctmU1_ur = SequentialCTMRG.from_elementary_tensors(
        "A", (tur_U1,), 20, degen_ratio=0.99
    )
