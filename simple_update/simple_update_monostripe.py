...
class SimpleUpdateMonostripe(SimpleUpdate2x2):
    ...
    def _2nd_order_step_no1(self):
        ...
        self.update_bond_proxy(6, 8, 1, 3, 2, sg1, self._dl2d, self._l2ur, self._ur2l)
        self.update_bond_proxy(3, 4, 2, 0, 1, sg1, self._l2u, self._d2dl, self._d2r)
        self.update_bond_proxy(5, 7, 1, 3, 2, sg1, self._r2u, self._ur2dl, self._u2r)
        self.update_bond_proxy(
            1, 2, 2, 0, 1, self._gates[1], self._r2d, self._dl2ur, self._u2l
        )
        self.update_bond_proxy(5, 7, 1, 3, 2, sg1, self._l2u, self._dl2dl, self._d2r)
        self.update_bond_proxy(3, 4, 2, 0, 1, sg1, self._r2u, self._ur2dl, self._u2r)
        self.update_bond_proxy(6, 8, 1, 3, 2, sg1, self._r2d, self._dl2ur, self._u2l)
        self.update_bond_proxy(3, 7, 0, 2, 3, sg1, self._dl2d, self._l2ur, self._ur2l)
        self.update_bond_proxy(6, 2, 3, 1, 0, sg1, self._l2u, self._d2dl, self._d2r)
